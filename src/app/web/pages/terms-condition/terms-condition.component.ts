...
export class TermsConditionComponent implements OnInit {
  ...
  selectedLang: any = 'en';
  langs: any = [];
  constructor(public ds: DataService,private translate: TranslateService,private spinner: NgxSpinnerService,private toastr: ToastrService, private commonService: CommonService) { }
  ...
  /*
   Name: Get Terms & condition
   Description: Api call to get the terms & condition page data on the basis of slug
   */
  async getPageData() {
    let path = 'pages/get-by-slug';
    return new Promise((resolve, reject) => {
      this.commonService.getById(path,'terms-condition').subscribe(async res => { 
