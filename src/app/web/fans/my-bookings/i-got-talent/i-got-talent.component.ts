...
@Component({
  selector: 'app-i-got-talent',
  templateUrl: './i-got-talent.component.html',
  styleUrls: ['./i-got-talent.component.scss']
})
export class IGotTalentComponent implements OnInit {
  modalRef: BsModalRef;
  ...
  */
  getAll() {   
    ...
    this.commonService.queryParams(path, options).subscribe(response => {
      ...
      console.log('this.dataList igt',this.dataList)
