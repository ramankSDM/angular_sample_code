...
@Component({
  selector: 'app-zoom-call-schedule',
  templateUrl: './zoom-call-schedule.component.html',
  styleUrls: ['./zoom-call-schedule.component.scss']
})
export class ZoomCallScheduleComponent implements OnInit {
  ...
  async getById() {
    ...
    return new Promise((resolve, reject) => {
      this.commonService.get(apiPath).subscribe(async res => {
        console.log('res.data', res.data, 'heree')
